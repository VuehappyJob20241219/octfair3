    ...
    <div class="resumeDetail_body_wrap">
        <div v-if="basicinformation" class="resumeDetail_body_basicInfo">
            <div class="flex-row" style="display: flex; align-items: center">
                ...
                <div class="content-section" style="flex: 1; margin-left: 20px">
                    <div class="inputRow">
                        <input
                            type="text"
                            v-model="basicinformation.resTitle"
                    ...
                    <ul>
                        ...
                        <li id="careerInputTable" class="inputTable" v-show="careerAddState">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            ...
                                            ></textarea>
                                            <div
                                                style="font-size: 12px; color: gray; margin: 5px 0; padding-left: 10px"
                                            >
                                                - 진행한 업무를 다 적기 보다는 경력사항 별로 중요한 내용만 엄선해서
                                                작성하는 것이 중요합니다!<br />
                                                - 경력별 프로젝트 내용을 적을 경우, 역할/팀구성/기여도/성과를 기준으로
                                                요약해서 작성해보세요!
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <div class="inputBtnGroup">
                                <a class="btnType gray cancleBtn" id="career" @click="showAddCareer"
                                    ><span>취소</span></a
                                >
                ...
                <div class="listDiv">
                    ...
                    <ul>
                        ...
                        <li id="educationInputTable" class="inputTable" v-show="eduAddState">
                                        ...
                                        <td>
                                            <div class="inputRow">
                                                ...
                                                <select
                                                    style="width: 80%"
                                                    id="eduLevel"
                                                    v-model="educationInfo.eduLevel"
                                                >
                                        ...
                                        <td>
                                            <div class="inputRow">
                                                ...
                                                <select
                                                    style="width: 80%"
                                                    id="grdStatus"
                                                    v-model="educationInfo.grdStatus"
                                                >
                            ...
                            <div class="inputBtnGroup">
                                <a class="btnType gray cancleBtn" id="education" @click="showAddEdu"
                                    ><span>취소</span></a
                                >
            ...
            <div class="resumeDetail_body">
                ...
                <ul>
                    ...
                    <li id="certificationInputTable" class="inputTable" v-show="certAddState">
                        ...
                        <div class="inputBtnGroup">
                            <a class="btnType gray cancleBtn" id="certification" @click="showAddCert"
                                ><span>취소</span></a
                            >
            ...
            <div class="resumeDetail_body">
                ...
                <div class="resumeDetail_body_guide">
                    <p class="resumeDetail_body_guide_text">
                        • 깃허브, 노션으로 작성한 포트폴리오, 구글 드라이브 파일 등 업무 성과를 보여줄 수 있는 링크가
                        있다면 작성해주세요.
                    </p>
                </div>
                <div>
            ...
            <div class="resumeDetail_body">
                ...
                <div class="resumeDetail_body_guide">
                    <p class="resumeDetail_body_guide_text">
                        • 포트폴리오, 경력기술서 등 첨부파일이 있다면 등록해주세요.
                    </p>
                </div>
                <!-- 첨부파일 -->
                <div class="listDiv">
            ...
            <div class="btnGroup">
                ...
                <button class="btnType gray list" @click="handerResumePreview(basicinformation.resIdx)">
                    미리보기
                </button>
            </div>
        </div>
