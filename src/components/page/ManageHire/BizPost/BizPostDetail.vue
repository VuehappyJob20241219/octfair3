  ...
  <template v-if="isSuccess">
            ...
            <div class="p-2 d-flex justify-content-center">
              ...
              <template v-else>
                <b-button
                  ...
                  size="lg"
                  style="width: 150px; color: #007bff; border-color: #007bff"
                  @click="handlerModal(postDetail.postIdx, bizDetail.bizIdx)"
                >
                  입사지원
                </b-button>
    ...
    <b-container class="mt-5">
      <div class="postDetailContainer">
        ...
        <div class="mt-5">
          <h5>■ 첨부 파일</h5>
          <span class="fileDown" @click="handleDown(postDetail.postIdx, bizDetail.bizIdx)">{{
            postDetail?.fileName
          }}</span>
        </div>
      </div>
      <template v-if="userType === 'b'">
        <div class="d-flex justify-content-center mt-5">
          <span style="color: red"> '대기중' 공고만 수정 및 삭제 가능합니다. </span>
        </div>
      </template>
      ...
      <div class="d-flex justify-content-center m-2">
        <template v-if="userType === 'B'">
          <div>
            <b-button variant="primary" size="lg" class="mx-1" @click="navigatePost(`${postDetail.postIdx}`)">
              수정하기
            </b-button>
            <b-button
              variant="primary"
            ...
            <b-button variant="secondary" size="lg" @click="navigatePost('back')"> 뒤로가기 </b-button>
          </div>
        </template>
        <template v-else>
          <template v-if="userType === 'M'">
            ...
            <b-button variant="outline-danger" class="me-2" @click="handlerUpdateAppStatus(postDetail.postIdx, '불허')">
              불허
            </b-button>
            <b-button variant="secondary" size="lg" @click="navigatePost('back')"> 뒤로가기 </b-button>
          </template>
